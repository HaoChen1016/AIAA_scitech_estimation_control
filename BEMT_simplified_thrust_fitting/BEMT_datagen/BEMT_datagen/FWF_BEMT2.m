function [T_final,lambda1,lambda2] = FWF_BEMT2(rpm_guesses,V_rel_b, P)
...
for i=1:4
    ...
    rpm=golden_search(1000,25000,subfcn2); %limits of RPM, checked that the higher limit goes beyond 25000 so chaging from 100 16000
